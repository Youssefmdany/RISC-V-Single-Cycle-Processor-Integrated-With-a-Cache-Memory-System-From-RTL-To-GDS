...
// Generated on 02/20/2025 at 02:54:11
// Library Name: RISCV_Top.dlib
// Block Name: Placement
// User Label: 
// Write Command: write_verilog /home/ICer/ASIC/RISCV/pnr/Placement/Placement_netlist.v
...
module Cache_Contrl ( clk , addr , mem_read , mem_write , miss , fill , 
    ready , stall , hit , HFSNET_5 ) ;
input  clk ;
input  [11:0] addr ;
input  [1:0] mem_read ;
input  [1:0] mem_write ;
...
DFFNARX1_HVT old_op_reg ( .D ( N33 ) , .CLK ( clk ) , .RSTB ( HFSNET_1 ) , 
    .Q ( old_op ) ) ;
...
DFFNARX1_HVT \valid_arr_reg[16] ( .D ( n171 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_2 ) , .Q ( valid_arr[16] ) , .QN ( n122 ) ) ;
DFFNARX1_HVT \valid_arr_reg[20] ( .D ( n175 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[20] ) , .QN ( n118 ) ) ;
DFFNARX1_HVT \valid_arr_reg[18] ( .D ( n173 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_4 ) , .Q ( valid_arr[18] ) , .QN ( n120 ) ) ;
DFFNARX1_HVT \valid_arr_reg[17] ( .D ( n172 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_3 ) , .Q ( valid_arr[17] ) , .QN ( n121 ) ) ;
DFFNARX1_HVT \valid_arr_reg[23] ( .D ( n178 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[23] ) , .QN ( n115 ) ) ;
DFFNARX1_HVT \valid_arr_reg[21] ( .D ( n176 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[21] ) , .QN ( n117 ) ) ;
DFFNARX1_HVT \valid_arr_reg[19] ( .D ( n174 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_0 ) , .Q ( valid_arr[19] ) , .QN ( n119 ) ) ;
DFFNARX1_HVT \valid_arr_reg[22] ( .D ( n177 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[22] ) , .QN ( n116 ) ) ;
DFFNARX1_HVT \valid_arr_reg[0] ( .D ( n155 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_2 ) , .Q ( valid_arr[0] ) , .QN ( n138 ) ) ;
DFFNARX1_HVT \valid_arr_reg[6] ( .D ( n161 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_4 ) , .Q ( valid_arr[6] ) , .QN ( n132 ) ) ;
DFFNARX1_HVT \valid_arr_reg[4] ( .D ( n159 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_2 ) , .Q ( valid_arr[4] ) , .QN ( n134 ) ) ;
DFFNARX1_HVT \valid_arr_reg[2] ( .D ( n157 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_0 ) , .Q ( valid_arr[2] ) , .QN ( n136 ) ) ;
DFFNARX1_HVT \valid_arr_reg[1] ( .D ( n156 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_2 ) , .Q ( valid_arr[1] ) , .QN ( n137 ) ) ;
DFFNARX1_HVT \valid_arr_reg[7] ( .D ( n162 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_0 ) , .Q ( valid_arr[7] ) , .QN ( n131 ) ) ;
DFFNARX1_HVT \valid_arr_reg[5] ( .D ( n160 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_3 ) , .Q ( valid_arr[5] ) , .QN ( n133 ) ) ;
DFFNARX1_HVT \valid_arr_reg[3] ( .D ( n158 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_0 ) , .Q ( valid_arr[3] ) , .QN ( n135 ) ) ;
DFFNARX1_HVT \valid_arr_reg[8] ( .D ( n163 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_2 ) , .Q ( valid_arr[8] ) , .QN ( n130 ) ) ;
DFFNARX1_HVT \valid_arr_reg[14] ( .D ( n169 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_4 ) , .Q ( valid_arr[14] ) , .QN ( n124 ) ) ;
DFFNARX1_HVT \valid_arr_reg[12] ( .D ( n167 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_3 ) , .Q ( valid_arr[12] ) , .QN ( n126 ) ) ;
DFFNARX1_HVT \valid_arr_reg[10] ( .D ( n165 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_4 ) , .Q ( valid_arr[10] ) , .QN ( n128 ) ) ;
DFFNARX1_HVT \valid_arr_reg[9] ( .D ( n164 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_2 ) , .Q ( valid_arr[9] ) , .QN ( n129 ) ) ;
DFFNARX1_HVT \valid_arr_reg[15] ( .D ( n170 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_0 ) , .Q ( valid_arr[15] ) , .QN ( n123 ) ) ;
DFFNARX1_HVT \valid_arr_reg[13] ( .D ( n168 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_3 ) , .Q ( valid_arr[13] ) , .QN ( n125 ) ) ;
DFFNARX1_HVT \valid_arr_reg[11] ( .D ( n166 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_0 ) , .Q ( valid_arr[11] ) , .QN ( n127 ) ) ;
DFFNARX1_HVT \valid_arr_reg[24] ( .D ( n148 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[24] ) , .QN ( n145 ) ) ;
DFFNARX1_HVT \valid_arr_reg[30] ( .D ( n154 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_2 ) , .Q ( valid_arr[30] ) , .QN ( n139 ) ) ;
DFFNARX1_HVT \valid_arr_reg[28] ( .D ( n152 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[28] ) , .QN ( n141 ) ) ;
DFFNARX1_HVT \valid_arr_reg[26] ( .D ( n150 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[26] ) , .QN ( n143 ) ) ;
DFFNARX1_HVT \valid_arr_reg[25] ( .D ( n149 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[25] ) , .QN ( n144 ) ) ;
DFFNARX1_HVT \valid_arr_reg[31] ( .D ( n147 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_2 ) , .Q ( valid_arr[31] ) , .QN ( n146 ) ) ;
DFFNARX1_HVT \valid_arr_reg[29] ( .D ( n153 ) , .CLK ( clk ) , 
    .RSTB ( HFSNET_1 ) , .Q ( valid_arr[29] ) , .QN ( n140 ) ) ;
DFFNARX1_HVT \valid_arr_reg[27] ( .D ( n151 ) , .CLK ( clk ) , 
...
module Data_Memory_System ( clk , mem_read , mem_write , byte_address , 
    DataIn , DataOut , Stall , p_aps_clk_data0 , HFSNET_5 ) ;
input  clk ;
input  [1:0] mem_read ;
input  [1:0] mem_write ;
...
Cache_Contrl cache_contrl ( .clk ( p_aps_clk_data0 ) ,
...
RISCV risc_v ( .clk ( net_aps_0 ) , .Stall ( Stall ) , .Rdata ( Rdata ) , 
    ...
    .p_aps_clk_data0 ( clk ) , .HFSNET_5 ( reset ) ) ;
Data_Memory_System data_mem_sys ( .clk ( net_aps_0 ) , .mem_read ( re ) , 
    .mem_write ( we ) , .byte_address ( Data_addr ) , .DataIn ( Wdata ) , 
    .DataOut ( Rdata ) , .Stall ( Stall ) , .p_aps_clk_data0 ( clk ) , 
    .HFSNET_5 ( reset ) ) ;
